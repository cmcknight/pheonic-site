...
const kindred = ['Dwarf (Gristlegrim)', 'Dwarf (Midgardian)', 'Elf', 'Fairy', 'Hobb', 'Human', 'Leprechaun'];

const heightInInches = [0, 0, 0, 52, 55, 58, 61, 63, 65, 67, 68, 69, 70, 72, 74, 76, 79, 82, 85];
